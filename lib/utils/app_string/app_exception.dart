...
class AppException implements Exception {
  ...
  static const MISSING_ACCESS_OR_ID_TOKEN = AppException('Missing_access_or_ID_token');
  static const USER_NOT_FOUND_SESSION = AppException('User_not_found_in_session');
